...
class SteamSignInPlugin extends Gdn_Plugin {
	...
	public function EntryController_SignIn_Handler($Sender, $Args) {
		if (isset($Sender->Data['Methods'])) {
			...
			// Add the steam openid method to the controller.
			$Method = array(
			'Name' => 'Steam',
			'SignInHtml' => "<a id=\"SteamAuth\" href=\"$SigninHref\" class=\"PopupWindow\" popupHref=\"$PopupSigninHref\" popupHeight=\"400\" popupWidth=\"800\" ><img src=\"$ImgSrc\" alt=\"$ImgAlt\" /></a>");
